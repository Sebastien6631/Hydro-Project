...
# Racine du projet (projet_hydro/, 3 niveaux au-dessus de ce fichier :
# src/projet_hydro/common/config.py -> src/projet_hydro/ -> src/ -> racine).
...
# vers un NAS distinct (projet_hydro/centrales/<dossier>/ n'était qu'un
